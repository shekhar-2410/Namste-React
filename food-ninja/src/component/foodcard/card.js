			...
			{restrautList.map((restaurant) => {
				return (
					<div
						...
						class="group box-border h-60 w-60 border-2 md:shadow-xl m-6 p-2 hover:bg-red-600  rounded-md"
					>
						<img
							src={
						...
						/>
						<h2 class="group-hover:text-white">{restaurant.data.name}</h2>
						<p class="text-sm group-hover:text-white">{restaurant.data.cuisines + ', '}</p>
						<p class="text-sm group-hover:text-white">{restaurant.data.avgRating} ⭐</p>
					</div>
				);
			})}
		</div>
